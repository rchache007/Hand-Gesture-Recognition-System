...
hand_tracking_object = media_p.solutions.hands
hands = hand_tracking_object.Hands(max_num_hands=1, min_detection_confidence=0.8)
...
while not False:
    ...
    if output.multi_hand_landmarks:
        ...
        for hlmarks in output.multi_hand_landmarks:
            ...
            m_d.draw_landmarks(window, hlmarks, hand_tracking_object.HAND_CONNECTIONS)
